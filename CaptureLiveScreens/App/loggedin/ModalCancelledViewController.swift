//
//  ModalCancelledViewController.swift
//  CaptureLive
//
...
class ModalCancelledViewController: UIViewController {
    ...
    func addEventHandlers() {
        self.theView.dismissButton?.addTarget(self, action: #selector(back), forControlEvents: .TouchUpInside)
    }
    
    func removeEventHandlers() {
        self.theView.dismissButton?.removeTarget(self, action: #selector(back), forControlEvents: .TouchUpInside)
    }
