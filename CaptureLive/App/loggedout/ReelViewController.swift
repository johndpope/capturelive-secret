...
class ReelViewController: UIViewController {
    ...
    func addEventHandlers() {
        theView.urlButton?.addTarget(self, action: #selector(addReel), forControlEvents:.TouchUpInside)
    ...
    func removeEventHandlers() {
        theView.urlButton?.removeTarget(self, action: #selector(addReel), forControlEvents:.TouchUpInside)
