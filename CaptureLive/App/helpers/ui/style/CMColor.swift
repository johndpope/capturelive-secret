...
extension UIColor {
    ...
    //MARK - OTHERS
    class func mediaPlaceholderColor()->UIColor {
    ...
    class func navbarDisabledBackgroundColor()->UIColor {
        return UIColor(red:0.239216, green:0.266667, blue:0.278431, alpha:1);
    }
    
    class func CMBackgroundColor()->UIColor {
        return UIColor(red:1, green:1, blue:1, alpha:1);
    }

    class func colorWithGreyRGB(rgb:Int, alpha:Float)->UIColor {
        let white = Float(rgb) / 255.0
        return UIColor(white:CGFloat(white), alpha:CGFloat(alpha));
    }
    
    class func colorWithGreyRGB(rgb:Int)->UIColor {
    ...
    class func fromHexString(hex:String, alpha:Float)->UIColor {
