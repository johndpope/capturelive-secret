...
{
    NSString* filename = [NSString stringWithFormat:@"%@/%@", CaptureMediaDirectory, @"lowres"];
    NSString* path = [NSTemporaryDirectory() stringByAppendingPathComponent:filename];
    path = [path stringByAppendingPathComponent:[NSString stringWithFormat:@"capture%d.mp4", _currentFile]];
...
- (void) initForHeight:(int)height andWidth:(int)width
{
    ...
    path = [path stringByAppendingPathComponent:[NSString stringWithFormat:@"params.mp4"]];
