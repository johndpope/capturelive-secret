...
public class EditorScrollView:UIScrollView, UIScrollViewDelegate {
    
    public var zoomView                                                :UIImageView!
    public var maxScale                                                :CGFloat!
    public var imageSize                                               :CGSize!
    public var pointToCenterAfterResize                                :CGPoint!
    public var scaleToRestoreAfterResize                               :CGFloat!
    public var isAlreadyZoomed                                         :Bool!
...
//    }
    ...
    public func reconfigureForImage() {
...
//        }
    ...
    public func maximumContentOffset()->CGPoint {
        let contentSize                                          = self.contentSize;
        let boundsSize                                           = self.bounds.size;
        return CGPointMake(contentSize.width - boundsSize.width, contentSize.height - boundsSize.height);
    }
    
    public func minimumContentOffset()->CGPoint {
        return CGPointZero;
    }
    
    public func setMaxMinZoomScaleForCurrentBounds() {
    ...
    public func kroppedImage()->(UIImage!) {
        // the image scale
